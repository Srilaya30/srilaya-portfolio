...
const RESUME_URL =
  "https://drive.google.com/file/d/1zxTQVI8XeoVgPLV7HWX4qG5dpvjx4SLN/view?usp=drive_link";
  ...
  head: () => ({
    meta: [
      { title: "Maddukuri Srilaya | Portfolio" },
      {
        name: "description",
        content:
          "Portfolio of Maddukuri Srilaya, a Computer Science (AI & ML) student, Java and Python developer, cloud enthusiast, and problem solver.",
      },
      ...
      { property: "og:title", content: "Maddukuri Srilaya | Portfolio" },
      {
        ...
        content:
          "Portfolio showcasing projects, skills, internships, certifications, and achievements by Maddukuri Srilaya.",
      },
...
function BackgroundFX() {
  return (
    ...
    >
      ...
      <div
        className="absolute top-1/3 -right-24 h-[300px] w-[300px] rounded-full glow-ring animate-glow sm:-right-40 sm:h-[520px] sm:w-[520px]"
        style={{ animationDelay: "1.5s" }}
      />
      <div
        className="absolute bottom-0 left-1/3 h-[240px] w-[240px] rounded-full glow-ring animate-glow sm:h-[360px] sm:w-[360px]"
        ...
        >
          <a href="#home" className="flex items-center gap-3 group">
            <span
              ...
              style={{
                ...
                boxShadow: "0 0 24px rgba(139,92,246,.55)",
              }}
            >
            ...
            <span className="hidden sm:block font-display font-bold tracking-tight">
              Srilaya<span className="text-gradient">.dev</span>
            </span>
          </a>
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="hidden md:inline-flex btn-primary rounded-full px-5 py-2.5 text-sm font-semibold"
            >
          ...
          <div className="lg:hidden mt-2 glass p-4 animate-fade-up">
            <div className="grid gap-1">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setOpen(false)}
                className="mt-2 btn-primary rounded-full px-5 py-2.5 text-sm font-semibold inline-flex items-center justify-center"
              >
                <Download className="mr-2 h-4 w-4" /> Download Resume
              </a>
            </div>
      ...
      <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <div className="animate-fade-up">
          ...
          <p className="mt-6 max-w-xl text-[#94A3B8] leading-relaxed">
            Computer Science and Engineering (AI &amp; ML) student passionate about building
            intelligent software solutions, scalable applications, and innovative technology-driven
            products. Skilled in Java, Python, DSA, Cloud Computing, and Modern Web Development.
          </p>
        ...
        <div
          className="relative h-[420px] overflow-hidden sm:h-[520px] animate-fade-up"
          style={{ animationDelay: ".15s" }}
        >
          <div
            className="absolute left-1/2 top-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full sm:h-[420px] sm:w-[420px]"
            style={{
              background:
                "radial-gradient(circle at 30% 30%, rgba(244,114,182,.55) 0%, rgba(139,92,246,.5) 42%, rgba(6,182,212,.28) 64%, transparent 78%)",
              filter: "blur(22px)",
              opacity: 0.9,
            }}
          />
          {/* Floating spheres */}
          <div
            className="absolute right-6 top-16 h-12 w-12 rounded-full animate-float"
            style={{
              background: "radial-gradient(circle at 30% 30%, #6ee7b7, #10b981)",
              boxShadow: "0 10px 30px rgba(16,185,129,.5)",
            }}
          />
          <div
            className="absolute right-2 bottom-24 h-16 w-16 rounded-full animate-float-slow"
            style={{
              background: "radial-gradient(circle at 30% 30%, #fde68a, #f59e0b)",
              boxShadow: "0 10px 30px rgba(245,158,11,.5)",
            }}
          />
          <div
            className="absolute left-2 bottom-12 h-8 w-8 rounded-full animate-float"
            style={{
              background: "radial-gradient(circle at 30% 30%, #c4b5fd, #8B5CF6)",
              boxShadow: "0 10px 30px rgba(139,92,246,.6)",
              animationDelay: "1s",
            }}
          />
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-4 text-[#E2E8F0] leading-relaxed">
              <p>
                ...
                at Pragati Engineering College.
              </p>
              <p>
                Passionate about software engineering, AI technologies, cloud computing, and solving
                real-world problems through innovative software solutions.
              </p>
              <p>
                Strong foundation in programming, data structures, algorithms, object-oriented
                programming, and full-stack development — focused on shipping work that's fast,
                accessible, and beautifully built.
              </p>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {SOFT.map((s, i) => (
                  <span
                    key={s}
                    className="glass px-3 py-1.5 text-xs font-medium text-[#E2E8F0] hover:text-white hover:border-[#8B5CF6]/50 transition"
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
                <div className="glass p-3">
                  <div className="text-[#94A3B8] text-xs">Location</div>
                  <div className="font-semibold mt-1">India</div>
                </div>
                <div className="glass p-3">
                  <div className="text-[#94A3B8] text-xs">Status</div>
                  <div className="font-semibold mt-1">Available</div>
                </div>
              </div>
            </div>
          </div>
...
const EDU = [
  {
    ...
    sub: "Computer Science and Engineering (AI & ML)",
        ...
        <div className="mt-14 relative">
          ...
          <div className="space-y-10">
            {EDU.map((e, i) => (
              <div
                key={i}
                className={`relative grid sm:grid-cols-2 gap-6 sm:gap-12 items-center ${i % 2 ? "" : ""}`}
              >
                <div
                  className={`pl-12 sm:pl-0 ${i % 2 ? "sm:order-2 sm:pl-12" : "sm:text-right sm:pr-12"}`}
                >
                  <div className="glass-strong glass card-hover p-6">
                    ...
                    <div className="hidden sm:block mt-2 text-xs uppercase tracking-wider text-[#94A3B8]">
                      {e.date}
                    </div>
                    <div
                ...
                <div
                  className="absolute left-4 sm:left-1/2 -translate-x-1/2 grid h-8 w-8 place-items-center rounded-full"
                  style={{
                    background: "linear-gradient(135deg,#8B5CF6,#06B6D4)",
                    boxShadow: "0 0 0 6px rgba(139,92,246,.15)",
                  }}
                >
...
const SKILLS: { icon: LucideIcon; title: string; items: string[] }[] = [
  ...
  { icon: Wrench, title: "Tools", items: ["Git", "GitHub", "VS Code", "PyCharm", "MS Excel"] },
  {
    icon: Brain,
    title: "Core Concepts",
    items: ["DSA", "OOP", "Problem Solving", "Software Development"],
  },
];
function Skills() {
  return (
    <section id="skills" className="section-pad">
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          ...
          desc="A toolkit spanning programming languages, frontend, backend, cloud and core CS fundamentals."
        />
            ...
            <div key={title} className="glass card-hover p-6 group">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {items.map((it) => (
                  <span
                    key={it}
                    className="rounded-lg bg-white/5 border border-white/10 px-2.5 py-1 text-xs font-medium text-[#E2E8F0] group-hover:border-[#8B5CF6]/40 transition"
                  >
                    {it}
                  </span>
                ))}
          ...
          {EXP.map((e) => (
            <div key={e.role} className="glass-strong glass card-hover p-6 sm:p-8">
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                <span
                  className="shrink-0 rounded-full px-3 py-1.5 text-xs font-semibold text-[#E2E8F0]"
                  style={{
              ...
              <ul className="mt-5 grid sm:grid-cols-2 gap-2 text-sm text-[#E2E8F0]">
                {e.bullets.map((b) => (
                  <li key={b} className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 mt-0.5 text-[#06B6D4] shrink-0" />
                    <span>{b}</span>
                  </li>
                ))}
              </ul>
              <div className="mt-5 flex flex-wrap gap-2">
                {e.tags.map((t) => (
                  <span
                    key={t}
                    className="rounded-lg bg-white/5 border border-white/10 px-2.5 py-1 text-xs font-medium text-[#c4b5fd]"
                  >
                    {t}
                  </span>
                ))}
    ...
    <section id="projects" className="section-pad">
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          ...
          desc="A selection of projects spanning AI, computer vision, and developer tooling."
        />
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <ul className="mt-4 space-y-1.5 text-xs text-[#E2E8F0]">
                  {p.features.map((f) => (
                    <li key={f} className="flex items-start gap-2">
                      <CheckCircle2 className="h-3.5 w-3.5 mt-0.5 text-[#06B6D4] shrink-0" />
                      {f}
                    </li>
                  ))}
                </ul>
                <div className="mt-5 flex flex-wrap gap-1.5">
                  {p.tech.map((t) => (
                    <span
                      key={t}
                      className="rounded-md bg-white/5 border border-white/10 px-2 py-0.5 text-[10px] font-medium text-[#c4b5fd]"
                    >
                      {t}
                    </span>
                  ))}
                ...
                <div className="mt-6 flex gap-2 pt-4 border-t border-white/10">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn-primary rounded-lg px-3 py-2 text-xs font-semibold inline-flex items-center gap-1.5 flex-1 justify-center"
                  >
              ...
              <div className="flex flex-1 flex-col p-6">
                <div className="flex items-start gap-3">
                  <span
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${c.color}, rgba(139,92,246,.35))`,
                      boxShadow: `0 10px 24px -12px ${c.color}`,
                    }}
                  >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-outline mt-5 inline-flex items-center justify-center rounded-lg px-4 py-2 text-xs font-semibold"
                >
        ...
        <div className="mt-12 grid sm:grid-cols-2 gap-6">
          {ACH.map(({ icon: Icon, ...a }) => (
            <div key={a.title} className="glass-strong glass card-hover p-8 text-center">
              <span
                className="mx-auto grid h-16 w-16 place-items-center rounded-2xl animate-glow"
                style={{
                  background: "linear-gradient(135deg,#F59E0B,#8B5CF6)",
                  boxShadow: "0 0 40px rgba(245,158,11,.5)",
                }}
              >
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid lg:grid-cols-5 gap-6">
          ...
          <form onSubmit={onSubmit} className="lg:col-span-3 glass-strong glass p-7 space-y-4">
            ...
            <button
              type="submit"
              className="btn-primary inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-semibold w-full sm:w-auto"
            >
              {sent ? (
                <>
                  Sent <CheckCircle2 className="ml-2 h-4 w-4" />
                </>
              ) : (
                <>
  ...
  const inner = (
    <div className="flex items-center gap-4">
      <span
        ...
        style={{
          background: "linear-gradient(135deg, rgba(139,92,246,.3), rgba(6,182,212,.3))",
          border: "1px solid rgba(139,92,246,.35)",
        }}
      >
        <Icon className="h-5 w-5 text-[#c4b5fd]" />
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3">
              <span
                className="grid h-10 w-10 place-items-center rounded-xl font-display font-extrabold text-white"
            ...
            <p className="mt-4 text-sm text-[#94A3B8] max-w-xs">
              AI & ML Student | Software Developer building intelligent, scalable software.
            </p>
          </div>
          <div>
            ...
            <ul className="grid grid-cols-2 gap-y-2 text-sm">
              {NAV.map(([id, label]) => (
                <li key={id}>
                  <a href={`#${id}`} className="text-[#94A3B8] hover:text-white transition">
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="grid h-10 w-10 place-items-center rounded-xl glass card-hover"
                aria-label="LinkedIn"
              >
